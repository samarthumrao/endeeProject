...
2. **Embedding Generation** – Ticket text (subject + description) is converted to a 384-dimensional vector using sentence-transformers
...
>>>>>>> 3592c9c (Update README with final user-provided content)
